...
def Vol() :
    ...
    Vol_1 = Boutonvolume.get() #valeur volume
...
photo = PhotoImage(file="picturemusic.gif")
Largeur=500
Hauteur=300
...
pygame.mixer.music.load('AlanWalker_DarkSide.mp3') #musique d'ouverture

#reglage des differents boutons
Play = PhotoImage(file="boutonplay.gif")
...
Pause = PhotoImage(file="boutonpause.gif")
...
Reprise = PhotoImage(file="playpause.gif")
